...
请判断这个站点是做什么的、它如何帮助用户发现 AI 工具，以及首屏或一次下滑范围内是否存在明确入口。
如果看到搜索、分类、热门工具或推荐入口，请点击一个最像主路径的入口验证；点击后看到新页面、列表变化或明确反馈即可总结并结束。
...
- `trust_and_confidence`: `partial` - 页面提供了部分信任信号：内容维护，但不足以完全建立用户信心
  ...
  截图证据：examples/ai-bot-cn/artifacts/v0.1.0/single-newcomer/screenshots/step-007.png
...
- `understanding_summary`: Agent 对产品定位的理解：网站是一个全面的AI工具导航平台，提供分类浏览、搜索和推荐功能。
